...
- [`ros_link_attacher`](https://github.com/pal-robotics/gazebo_ros_link_attacher) pkg (already included within this repository as [gazebo_ros_link_attacher](gazebo_ros_link_attacher))
