...
// Spawn SRS 2
  ...
  // detachModels("srs_main", "base_link", "srs_1", "base_link");

  // detachModels("srs_main2", "base_link", "srs_2", "base_link");

  // detachModels("srs_main3", "base_link", "srs_3", "base_link");

  // detachModels("srs_main4", "base_link", "srs_4", "base_link");

  // detachModels("srs_main5", "base_link", "srs_5", "base_link");
