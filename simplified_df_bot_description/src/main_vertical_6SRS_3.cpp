...
void arm1listenAndExecute0(const std::string& target_model,
...
void arm2listenAndExecute0(const std::string& target_model,
                          geometry_msgs::Pose& arm1_pose,
                          geometry_msgs::Pose& arm2_pose,
                          moveit::planning_interface::MoveGroupInterface& rng_group_interface,
                          moveit::core::RobotStatePtr& kinematic_state,
                          ...
                          const std::vector<std::string>& arm2_joint_names)
{
  ...
  while (nh.ok())
  {
    ...
    // double midpoint_error_x = midpoint_robot_coords.position.x - arm1_pose.position.x;
    // double midpoint_error_y = midpoint_robot_coords.position.y - arm1_pose.position.y;
    ...
    // ROS_FATAL("Midpoint (robot frame): x = %f, y = %f, z = %f", midpoint_robot_coords.position.x, midpoint_robot_coords.position.y, midpoint_robot_coords.position.z);
    // ROS_ERROR("Midpoint Error (robot frame): x = %f, y = %f, z = %f", midpoint_error_x, midpoint_error_y, midpoint_error_z);
    // ROS_ERROR("Midpoint (robot frame) a1: z = %f", midpoint_robot_coords.position.z);
    // ROS_ERROR("Midpoint Error (robot frame) a1: z = %f", midpoint_error_z);
    // ROS_INFO("Arm1_pose a1: z = %f", arm1_pose.position.z);
    // ROS_INFO("Arm2_pose a1: z = %f", arm2_pose.position.z);
                          ...
                          const std::vector<std::string>& arm2_joint_names)
{
  ...
  while (nh.ok())
  {
    ...
    // midpoint_robot_coords.position.x = (arm1_pose.position.x + arm2_pose.position.x) / 2.0;
    // midpoint_robot_coords.position.y = (arm1_pose.position.y + arm2_pose.position.y) / 2.0;
    // midpoint_robot_coords.position.z = (transformStamped.transform.translation.z + arm2_pose.position.z) / 2.0;

    // double midpoint_error_x = midpoint_robot_coords.position.x - arm1_pose.position.x;
    // double midpoint_error_y = midpoint_robot_coords.position.y - arm1_pose.position.y;
    // double midpoint_error_z = midpoint_robot_coords.position.z - arm1_pose.position.z;
    ...
    // double midpoint_error_x = midpoint_robot_coords.position.x - arm2_pose.position.x;
    // double midpoint_error_y = midpoint_robot_coords.position.y - arm2_pose.position.y;
    // double midpoint_error_z = midpoint_robot_coords.position.z - arm2_pose.position.z;
    ...
    // ROS_ERROR("Midpoint (robot frame) a2: z = %f", midpoint_robot_coords.position.z);
    // ROS_ERROR("Midpoint Error (robot frame) a2: z = %f", midpoint_error_z);
    // ROS_INFO("Arm1_pose a2: z = %f", arm1_pose.position.z);
    // ROS_INFO("Arm2_pose a2: z = %f", arm2_pose.position.z);
      
    arm1_pose.position.z = 0.0;
